...
export const V3_CODE = `
// ENGINE v6.5.0 - HIGH-FIDELITY VECTOR SIMULATION
// Includes: Expanded Font Stacks, Safety Buffers, and DOM Font Injection support.
`;
...
export const renderPDF_V3 = async (
  ...
  // Prioritizes user custom fonts, then system UI fonts, then broad script support fonts
  const fontStack = [
