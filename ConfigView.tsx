...
import { ArrowLeft, Target, Percent, Ruler } from 'lucide-react';
import { PaperSize, OutputMode, BorderConfig } from './types';
    ...
    <div className="max-w-2xl mx-auto w-full p-8 flex-1 flex flex-col animate-in fade-in pb-10 min-h-screen">
      ...
      <div className="space-y-10 mb-12">
        ...
        <div className={`${t.card} p-10 rounded-[3rem] border shadow-xl space-y-6`}>
           ...
           <p className="text-[9px] text-zinc-500 font-mono pl-2">
             {borderConfig.mode === 'PERCENT' ? 'Calculated from smallest side. Default: 3.7%' : 'Fixed millimeter margin. Default: 3.7% converted.'}
           </p>
        </div>
