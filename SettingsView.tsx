...
import { ArrowLeft, Palette, Shield, Activity, ChevronRight, ToggleRight, ToggleLeft, Database, Type, BrainCircuit, Code2, LayoutTemplate } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto w-full p-8 flex-1 flex flex-col animate-in fade-in duration-300">
      ...
      <div className="space-y-6 mt-8 pb-20">
        ...
        {/* INTERFACE COLOR */}
        <button onClick={() => setSubView('interface_color')} className="w-full bg-zinc-950/50 p-10 rounded-[3.5rem] text-left flex items-center justify-between border border-white/5 shadow-2xl group hover:bg-zinc-900 transition-all overflow-hidden relative">
          <div className="flex items-center space-x-6 relative z-10">
            <div className="p-5 bg-black/40 rounded-[2rem] border border-white/5 relative">
