...
import { ArrowLeft, Cpu, Globe, Zap, ShieldCheck, Database, RefreshCcw } from 'lucide-react';
        ...
        <div className="p-8 bg-zinc-900/30 border border-white/5 rounded-[3rem]">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-[11px] leading-relaxed mt-2 opacity-40">System environment key is currently managed by the root container. Manual key override is disabled for security parity.</p>
            </div>
          </div>
        </div>
      </div>
