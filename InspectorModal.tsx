...
import { X, ChevronDown, ChevronRight, FileText, FolderOpen, ArrowDown, ArrowUp, Database, Search } from 'lucide-react';
...
const buildTreeFromFiles = (files: File[], rootName: string, customPath?: string, searchTerm?: string): TreeNode => {
  const root: TreeNode = {
    name: rootName,
    type: 'folder',
    children: [],
...
const RecursiveTreeRenderer: React.FC<{ node: TreeNode, level?: number, t: any, searchTerm: string }> = ({ node, level = 0, t, searchTerm }) => {
